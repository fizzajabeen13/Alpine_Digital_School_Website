...
export default function FeaturedDeveloperProfile() {
  ...
  <div className="inline-flex items-center gap-2 rounded-full border border-green-400/30 bg-green-500/10 px-4 py-3 text-xs font-semibold text-green-300 backdrop-blur-xl sm:px-5 sm:text-sm">
    <CircleCheck size={18} className="shrink-0 text-green-400" />
    Available for Student Mentoring
  </div>

  <div className="inline-flex items-center gap-2 rounded-full border border-blue-400/20 bg-blue-500/10 px-4 py-3 text-xs font-semibold text-blue-300 backdrop-blur-xl sm:px-5 sm:text-sm">
...
{featuredDeveloper.video && (
  <a
    href={featuredDeveloper.video}
    target="_blank"
    rel="noopener noreferrer"
    className="group inline-flex items-center justify-center rounded-xl border border-cyan-400/30 bg-cyan-400/10 px-6 py-3 text-base font-medium backdrop-blur-xl transition-colors hover:bg-cyan-400/20"
  >
    <Play
